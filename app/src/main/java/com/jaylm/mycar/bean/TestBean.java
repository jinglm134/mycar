...
public class TestBean {
    ...
    private List<SchoolDetailBean.CorpMarksBean> CorpMarks;
    ...
    public List<SchoolDetailBean.CorpMarksBean> getCorpMarks() {
        return CorpMarks;
    }

    public void setCorpMarks(List<SchoolDetailBean.CorpMarksBean> CorpMarks) {
